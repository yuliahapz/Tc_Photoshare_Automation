...
public class Unlike {
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement likeButton = driver.findElement(By.cssSelector("button svg.text-red-500"));
            ...
            if (true) {
                System.out.println("Unlike Test Successful: Post berhasil di-Unlike.");
            }else {
                System.out.println("Unlike Test Failure: Post tidak di-Unlike.");
            }
